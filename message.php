        ...
        <div class="main-content message">
            ...
            <div class="row mt-5">
                <div class="col-lg-6 col-md-6">
                    ...
                    <input class="form-control-md outline-none w-75 px-2 py-2" type="text" name="name" id=""
                        value="Name Surname"> <br> <br>
                    <label class="fw-bold fs-5" for="name">Principal:</label> <br>
                    <input class="form-control-md outline-none w-75 px-2 py-2" type="text" name="post" id=""
                        value="Principal"> <br> <br>
                </div>
                <div class="col-lg-6 col-md-6">
                    <label class="fw-bold fs-5" for="name">Email:</label> <br>
                    <input class="form-control-md outline-none w-75 px-2 py-2" type="text" name="email" id=""
                        value="username@mbman.soe.edu.np"> <br> <br>
                    <label class="fw-bold fs-5" for="name">Phone no:</label> <br>
                    <input class="form-control-md outline-none w-75 px-2 py-2" type="text" name="phone" id=""
                        value="+9779800000"> <br> <br>
                </div>
            </div>
