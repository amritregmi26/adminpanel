                ...
                <ul class="nav nav-pills" id="menu">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="collapse nav flex-column ms-3" id="submenu1" data-bs-parent="#menu">
                            ...
                            <li class="w-100">
                                <a href="./home-course.php" class="nav-link px-0">
                                    <span class="d-none d-sm-inline">
                                        Course Section
                                    </span>
                                </a>
    ...
    <main class="right-pane">
        ...
        <div class="main-content">
            <div class="mt-5 fw-bold">
                <h1 class="mb-2 text-capitalize">message details</h1>
            </div>
            <div class="detail-wrapper flex-fix">
                <div class="section-name-container">
                    <div class="header text-capitalize">section name</div>
                    <div class="main-content text-capitalize">testimonials</div>
                </div>
                <div class="content-container">
                    <div class="header text-capitalize">saying</div>
                    <div class="main-content">
                        <p>
            ...
            <div class="mt-5 fw-bold">
                <h1 class="mb-2 text-capitalize">student's details</h1>
            </div>
            <div class="detail-wrapper flex-fix">
                <div class="name-container">
                    <div class="header text-capitalize">name of student</div>
                ...
                <div class="img-container">
                    ...
                    <div class="main-content">
                        <img src="./assets/img/person.jpg" alt="School's Image">
                    </div>
                </div>
                <div class="class-details">
                    <div class="header text-capitalize">class / section</div>
                    <div class="main-content text-capitalize">
                        class XII B
                    </div>
                </div>
